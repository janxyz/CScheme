...
struct scm_obj const* const scm_nil = &(struct scm_obj){ .type = TYPE_NIL };
struct scm_obj const* const scm_false = &(struct scm_obj){ .type = TYPE_BOOLEAN };
struct scm_obj const* const scm_true = &(struct scm_obj){ .type = TYPE_BOOLEAN };
